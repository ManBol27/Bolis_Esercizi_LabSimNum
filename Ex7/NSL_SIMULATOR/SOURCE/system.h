...
private:
  ...
  double _global_sh_av; //variabile che uso per contenere a parte il calore specifico, che si sommerà blocco dopo blocco
  double _global_sh_av2; //idem ma per il calore specifico al quadrato
...
public: // Function declarations
  ...
  void initialize_properties_T_(); //Initialize files for measurements depending on tmeperature
  ...
  double get_temperature_measurement(); // Get the current value of temperature
  double get_potential_measurement();    // Get the current value of pressure
};
