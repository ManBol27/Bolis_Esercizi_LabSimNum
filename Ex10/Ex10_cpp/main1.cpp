...
void Genetic (int M, int G, vector<vector<double>> cities, int generations, Random  rnd, double prob_mut, double prob_cross, string type_path, int &rank) {
...
// Inizializzazione generatore numeri casuali
   ...
   int generations = 1200 ; //numero di generazioni, ovvero numero di volte che viene creata una nuova popolazione a partire da quella precedente
   ...
   */
   ...
   Genetic (M, G, ita_cities, generations, rnd, prob_mut, prob_cross, type_path, rank);
